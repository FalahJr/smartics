...
class RegisterController extends Controller
{
    ...
    public function doregister(Request $req) {
      ...
      try {
        ...
        $cekemail = DB::table("users")->where("users_email", $email)->first();
        $cekusername = DB::table("users")->where("users_username", $username)->first();
        $ceknohp = DB::table("users")->where("users_nohp", $nohp)->first();

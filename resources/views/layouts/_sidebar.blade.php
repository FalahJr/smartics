            ...
            <li class="nav-item {{Request::is('survey') || Request::is('survey/*') ? 'active' : ''  }}">
              ...
              <div class="collapse {{Request::is('survey') || Request::is('survey/*') ? 'show' : '' }}" id="survey">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link {{Request::is('survey/laporan-survey') || Request::is('survey/laporan-survey/*') ? 'active' : ''  }}" href="{{url('survey/laporan-survey')}}">Riwayat Survey<span class="d-none">Setting</span></a></li>
                  @endif

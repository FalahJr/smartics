                    ...
                    <form id="form1" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label for="jawaban"  >{{ $index + 1 }}) {{ $list->pertanyaan }}</label>
                                <input type="hidden" class="form-control" name="survey_pertanyaan_id[]" value="{{ $list->id }}">
                                <textarea class="form-control mt-2" name="jawaban[]"></textarea>
...
$('#kirim').click(function() {
    var formData = {
        'survey_id': $('#id').val(),
        'survey_pertanyaan_id': $('[name="survey_pertanyaan_id[]"]').map(function() {
            return $(this).val();
        }).get(),
        'jawaban': $('[name="jawaban[]"]').map(function() {
            return $(this).val();
        }).get()
    };
